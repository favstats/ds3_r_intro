...
<img src="images/rrrrrrr.png" align="right" width="200"/>
...
##  Install <img src="images/Rlogo.svg" width="25px"/>
...
## Install  <img src="images/rstudio.png" width="70px"/>

Next, please download & install RStudio. 

RStudio is a graphical interfance in which we can program in R. You can write, save and open R Code (.R/.Rmd files) within RStuio an it also provides syntax-highlighting, auto-completion & much more conveniences!
